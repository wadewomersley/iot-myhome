namespace IOT_MyHome.Logging
{
    ...
    internal class CustomConsoleLogger : ILogger
    {
        ...
        internal CustomConsoleLogger(string name, Func<string, LogLevel, bool> filter, bool includeScopes, ConsoleLoggerProcessor loggerProcessor)
        {
            if (name == null)
            {
        ...
        {            var now = "[" + DateTime.UtcNow.ToString("s", System.Globalization.CultureInfo.InvariantCulture) + "] ";
            ...
            {
                var hasLevel = !string.IsNullOrEmpty(logLevelString);                logBuilder.Replace(Environment.NewLine, Environment.NewLine + now);
                // Queue log message
